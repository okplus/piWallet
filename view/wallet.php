...
<td><a href="<?php echo $server_url;?>qr/<?php echo $address;?>">
  <img src="<?php echo $server_url;?>qr/<?php echo $address;?>" alt="QR Code" style="width:42px;height:42px;border:0;"></td><tr>
<?php
}
?>
</tbody>
